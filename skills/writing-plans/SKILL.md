---
name: writing-plans
description: Use after an approved design/spec or clear requirements exist and before implementing a multi-step task; creates a task-by-task implementation plan before code changes.
---
