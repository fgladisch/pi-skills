---
name: simplify
description: Use after making code changes, before committing, or when the user asks to "simplify", "clean up", or "review" recent edits — runs three parallel review agents (reuse, quality, efficiency) over the diff and fixes the findings.
---
